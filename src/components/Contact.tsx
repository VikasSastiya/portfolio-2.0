            ...
            <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  name="message"
                  rows={6}
                  className="w-full px-4 py-3 rounded-lg bg-white/5 border border-white/10 text-white placeholder-white/50 focus:outline-none focus:border-[#F45D01] transition-colors resize-none"
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-[#F45D01] to-[#6559FF] text-white py-4 rounded-lg font-medium hover:opacity-90 transition-opacity"
              >
                Send Message
              </button>
            </form>
          ...
          <div className="space-y-8">
            <div className="backdrop-blur-sm bg-white/5 rounded-3xl p-8 shadow-2xl border border-white/10">
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-full bg-[#F45D01]/10 flex items-center justify-center">
                    <svg
                      className="w-6 h-6 text-[#F45D01]"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                ...
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-full bg-[#6559FF]/10 flex items-center justify-center">
                    <svg
                      className="w-6 h-6 text-[#6559FF]"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
            ...
            <div className="backdrop-blur-sm bg-white/5 rounded-3xl p-8 shadow-2xl border border-white/10">
              ...
              <div className="flex gap-4">
                ...
                <a
                  href="#"
                  className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center hover:bg-[#6559FF] transition-colors"
                >
                  <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
