...
const About: FC<AboutProps> = ({ scrollToSection }) => {
  ...
  return (
    <section ref={aboutRef} className="relative p-10">
      {/* Content */}
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center about-content-left">
          {/* Text Content */}
          <div className="space-y-8">
            <h2 className="text-4xl sm:text-5xl font-bold text-white about-content-left-title">
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#F45D01] to-[#6559FF]">
                About Me
              </span>
            </h2>
            <div ref={textRef} className="text-lg text-white/80 leading-relaxed about-content-left-text">
            ...
            <div className="flex flex-wrap gap-4 about-content-right-buttons">
              <a id="chars" href="/cv.pdf" download type='' className="px-6 py-3 bg-gradient-to-r from-[#F45D01] to-[#6559FF] text-white rounded-full font-semibold hover:shadow-lg hover:shadow-[#F45D01]/20 transition-all duration-300">
                Download CV
              </a>
              <button   id="words" onClick={() => scrollToSection('skills')} className="px-6 py-3 border-2 border-white/20 text-white rounded-full font-semibold hover:bg-white/10 transition-all duration-300">
                View Skills
              </button>
