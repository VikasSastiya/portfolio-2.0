...
const Footer: FC<FooterProps> = ({ scrollToSection }) => {
  ...
  return (
    <footer ref={sectionRef} className="relative py-16 overflow-hidden">
      {/* 3D Background Elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="footer-bg-element absolute top-1/3 left-1/3 w-96 h-96 bg-[#6559FF] rounded-full blur-3xl opacity-20" />
        <div className="footer-bg-element absolute bottom-1/3 right-1/3 w-96 h-96 bg-[#F45D01] rounded-full blur-3xl opacity-20" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div ref={el => { elementsRef.current[0] = el }} className="footer-card space-y-6 transform-gpu">
            ...
            <div className="flex gap-4">
              <a
                href="#"
                className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-[#F45D01] transition-colors transform-gpu hover:scale-110 hover:rotate-12"
              >
              ...
              <a
                href="#"
                className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-[#6559FF] transition-colors transform-gpu hover:scale-110 hover:-rotate-12"
              >
                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div ref={el => { elementsRef.current[2] = el }} className="footer-card transform-gpu">
            ...
            <ul className="space-y-4">
              <li>
                <a href="#" className="text-white/70 hover:text-[#6559FF] transition-colors transform-gpu hover:translate-x-2">
                  Web Development
                </a>
              </li>
              <li>
          ...
          <div ref={el => { elementsRef.current[3] = el }} className="footer-card transform-gpu">
            ...
            <ul className="space-y-4">
              <li className="flex items-center gap-3">
                <svg
                  className="w-5 h-5 text-[#F45D01] transform-gpu hover:rotate-12"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <li className="flex items-center gap-3">
                <svg
                  className="w-5 h-5 text-[#6559FF] transform-gpu hover:-rotate-12"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
        ...
        <div className="mt-16 pt-8 border-t border-white/10">
          <p className="text-center text-white/50 transform-gpu hover:scale-105">
